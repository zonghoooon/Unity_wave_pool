Shader "Custom/Wave"
{
    Properties
    {
        ...
        _WaveInt("Wave Int", float) = 4
        _WaveFre("Wave Frequency",float) = 0.5
        ...
        SubShader
        {
            ...
            {
                float4 res = sin(v.texcoord.x * _WaveInt + _Time.y * _WaveSpeed) - _WaveFre;
                v.vertex.y = (res + abs(res)) * _WaveHeight;
            }
